...
begin
	...
	regs(16) 	<= regs_i(16);	-- Signature_0		
	regs(17) 	<= regs_i(17);	-- Signature_1
	regs(18) 	<= regs_i(18);	-- Signature_2
	regs(19) 	<= regs_i(19);	-- Signature_3	
	regs(20)		<= regs_i(20);	-- Signature_4, Error Count, Signature valid	
	...
	if reset='1' then
		...
		------------------------
		-- exp. ffff ff000000 00000000 0000ffff ffffffff	
		-- mask 0000 01800000 00000000 00018000 00000000
		------------------------
		regs(21) <= x"fff00000";-- default exp_signature [ 31:  0]
		regs(22) <= x"ffffffff";-- default exp_signature [ 63: 32]	
		regs(23) <= x"000fffff";-- default exp_signature [ 95: 64]	
		regs(24) <= x"00000000";-- default exp_signature [127: 96]	
		regs(25) <= x"00000000";-- default exp_signature [143:128]
		
		regs(26) <= x"003c0000";-- default signature_mask[ 31:  0]	
		regs(27) <= x"00000000";-- default signature_mask[ 63: 32]		
		regs(28) <= x"003c0000";-- default signature_mask[ 95: 64]
		regs(29) <= x"00000000";-- default signature_mask[127: 96]
		regs(30) <= x"00000000";-- default signature_mask[143:128]		
