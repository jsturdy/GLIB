...
xst -ifn xst.scr
move ttclk_mmcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ttclk_mmcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ttclk_mmcm_exdes.ucf ttclk_mmcm_exdes

echo 'Running map'
map -timing -pr b ttclk_mmcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ttclk_mmcm_exdes -w routed.ncd routed.vhd
cd ..
