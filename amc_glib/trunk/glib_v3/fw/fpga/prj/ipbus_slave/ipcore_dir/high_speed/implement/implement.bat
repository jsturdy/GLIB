...
COPY high_speed_top.ngc .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\high_speed_top.ucf -p xc6vlx130t-ff1156-1 high_speed_top.ngc high_speed_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx130t-ff1156-1 -o mapped.ncd high_speed_top.ngd
...
netgen -ofmt vhdl -sim -dir . -tm high_speed_top -w routed.ncd routed.vhd
