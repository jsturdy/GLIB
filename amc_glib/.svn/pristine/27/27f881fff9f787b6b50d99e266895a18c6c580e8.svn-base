...
signal 	fmc1_refclk0								: std_logic;	
signal 	sfp_refclk0									: std_logic;	
---------------------------------------
...
--										regs_from_wb(32+31)						;
	...
	port map 
	(
		clk_i 					=> tx_frameclk(sfp), --essentially the cdce_clkout4, guaranteed timing of the link resets --wb_mosi_i(user_wb_regs).wb_clk,
		reset_i 				=>	reset,
	...
	--===============================================================================================--
	fmc1_gtxe1:   ibufds_gtxe1 port map ( i => fmc1_refclk_p(0), ib => fmc1_refclk_n(0), o => fmc1_refclk0, ceb => '0');
	--===============================================================================================--



	--===============================================================================================--
	fmc1_tx_frameclk_bufg:bufg port map ( o => tx_frameclk(fmc1),	i 	=> cdce_clkout4);
	--===============================================================================================--
	...
	--%%%%% gtx in <- user %%%%%%%                                                                  	
												...
												gtx_i(fmc1).tx_refclk		<=	fmc1_refclk0								; 
												gtx_i(fmc1).tx_data 			<= gbt_enc_o(fmc1).word						;
												gtx_i(fmc1).rx_refclk		<=	fmc1_refclk0								; 
   ...
   fmc2_led(3)	 						<=	gtx_o(fmc1).resetdone 															;
	...
	--===============================================================================================--
	sfp_gtxe1:   ibufds_gtxe1 port map ( i => sfp_refclk_p(0), ib => sfp_refclk_n(0), o => sfp_refclk0, ceb => '0');
	--===============================================================================================--



	--===============================================================================================--
	sfp_tx_frameclk_bufg:bufg port map ( o => tx_frameclk(sfp),	i 	=> cdce_clkout4);
	--===============================================================================================--
	...
	--%%%%% gtx in <- user %%%%%%%
												...
												gtx_i(sfp).tx_refclk			<=	sfp_refclk0								; 
												gtx_i(sfp).tx_data 			<= gbt_enc_o(sfp).word					;
												gtx_i(sfp).rx_refclk			<=	sfp_refclk0								; 
   ...
   fmc2_led(4)	 						<=	gtx_o(sfp).resetdone 														;
	...
	--===============================================================================================--
		fmc2_led(1)					<= mac_syncacqstatus_i(phy)  and mac_serdes_locked_i(phy);--mac_syncacqstatus_i(phy);
		fmc2_led(2)					<= mac_syncacqstatus_i(fmc2) and mac_serdes_locked_i(fmc2);--mac_syncacqstatus_i(phy);
   ...
   port		map(reset => reset, clka => clk_125, clkb => pri_clk, heartbeat_clka => fmc1_led(1), heartbeat_clkb => fmc1_led(2));
	--===============================================================================================--
