...
xst -ifn xst.scr
move xlx_v6_tx_mmcm_FABRIC_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\xlx_v6_tx_mmcm_FABRIC_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc xlx_v6_tx_mmcm_FABRIC_exdes.ucf xlx_v6_tx_mmcm_FABRIC_exdes

echo 'Running map'
map -timing -pr b xlx_v6_tx_mmcm_FABRIC_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm xlx_v6_tx_mmcm_FABRIC_exdes -w routed.ncd routed.vhd
cd ..
